...
lyr_station_coordinates_1.set('fieldLabels', {'No': 'inline label - always visible', 'Station_Name': 'inline label - always visible', 'Address': 'inline label - always visible', 'Coordinate': 'inline label - always visible', 'Type': 'inline label - always visible', 'Longtitude': 'inline label - always visible', 'Latitude': 'inline label - always visible', });
